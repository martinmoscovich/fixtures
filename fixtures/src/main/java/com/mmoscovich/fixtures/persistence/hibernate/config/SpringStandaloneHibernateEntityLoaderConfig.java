 ...
 *
 */
public class SpringStandaloneHibernateEntityLoaderConfig extends HibernateEntityLoaderConfigBase {
	 ...
	 */
	public SpringStandaloneHibernateEntityLoaderConfig(ApplicationContext context, boolean springManagedTransactions) {
	 ...
	 * @param springManagedTransactions indicates whether Spring manages transactions
	 */
	public SpringStandaloneHibernateEntityLoaderConfig(ApplicationContext context, String sessionFactoryBeanName, boolean springManagedTransactions) {
	 ...
	 * @param springManagedTransactions indicates whether Spring manages transactions
	 */
	public SpringStandaloneHibernateEntityLoaderConfig(String contextLocation, boolean springManagedTransactions) {
	 ...
	 * @param springManagedTransactions indicates whether Spring manages transactions
	 */
	public SpringStandaloneHibernateEntityLoaderConfig(String contextLocation, String sessionFactoryBeanName, boolean springManagedTransactions) {
